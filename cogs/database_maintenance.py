...
#
  ...
  async def on_guild_join(self, guild):
    ...
    default_prefix = '$'
    cur.execute("INSERT INTO SERVERS_PROPERTIES (GUILD_ID,GUILD_NAME,DATE_OF_JOIN,GUILD_PREFIX,NUMBER_OF_USERS,ANTY_SPAM_FEATURE,ECONOMY,MUSIC,UPDATES) VALUES ('{}', '{}', '{}', '$', '{}', '{}', '{}', '{}')".format(guild.id, guild.name, get_time("DD"), guild.member_count, "NO", "NO", "YES", "NO"));
    con.commit()
#
