...
function get_permissions($usr_permissions_dec) {
    $gen_permissions_codes = [
        ...
        // General x15
        'generalAdministrator' => 0x00000008,
        'generalViewAuditLog' => 0x00000080,
        'generalManageServer' => 0x00000020,
        'generalManageRoles' => 0x10000000,
        'generalManageChannels' => 0x00000010,
        'generalKickMembers' => 0x00000002,
        'generalBanMembers' => 0x00000004,
        'generalCreateInstantInvite' => 0x00000001,
        ...
        'generalReadMessagesViewChannels' => 0x00000400,
        'generalManageEvents' => 0x200000000,
        'generalModerateMembers' => 0x10000000000,
        // Text x15
        'textSendMessages' => 0x00000800,
        'textCreatePublicThreads' => 0x800000000,
        'textCreatePrivateThreads' => 0x1000000000,
        'textSendMessagesInThreads' => 0x4000000000,
        'textSendTTSMessages' => 0x00001000,
        'textManageMessages' => 0x00002000,
        'textManageThreads' => 0x400000000,
        'textEmbedLinks' => 0x00004000,
        'textAttachFiles' => 0x00008000,
        'textReadMessageHistory' => 0x0010000,
        'textMentionEveryone' => 0x0020000,
        'textUseExternalEmojis' => 0x0040000,
        'textUseExternalStickers' => 0x2000000000,
        'textAddReactions' => 0x0000040,
        ...
        'voicePrioritySpeaker' => 0x0000100
    ];
