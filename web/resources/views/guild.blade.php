        ...
        <div class="app-grid-container">
            <div class="app-left">
                ...
                <div class="app-dropdown">
                    <button id="app-dropdown-button" class="app-flex-container" onclick="search_dropdown()"> <?php echo '<img class="app-icon" src="' . get_icon($thisGuild) . '"/>' . $thisGuild->name; ?> </button>
