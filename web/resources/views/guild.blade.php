        ...
        <div class="app-grid-container">
            <div class="app-left">
                ...
                <div class="app-dropdown">
                    <button id="app-dropdown-button" class="app-flex-container" onclick="search_dropdown()"> <?php echo '<img class="app-icon" onclick="search_dropdown()" src="' . get_icon($thisGuild) . '"/><h4 onclick="search_dropdown()" class="app-no-margin">' . $thisGuild->name . '</h4>'; ?> </button>
