        ...
        <div id="blur" class="container">
            ...
            <div class="page-aside">
                ...
                <ul>
                    ...
                    <li <?php if($view == 'debug') { echo 'class="selected"';} ?> ><a href="/manage/guild/<?php echo $id; ?>/debug" ><span class="aside-icon" ><ion-icon name="terminal-outline"></ion-icon></span><span class="title" >Debugging</span></a></li>
                    <li class="space"></li>
