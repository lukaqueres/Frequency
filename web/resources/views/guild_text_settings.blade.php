...
<html>
    <head>
        <title> Plant It | Text settings</title>
    ...
    <body>
        <div id="blur" class="container">
            ...
            <div class="page-aside">
                ...
                <ul>
                    <?php echo '<li class="space"><a href="#"><span class="aside-icon"><img class="icon" src="' . $guild->icon_url . '"/></span><span class="title">' . $guild->name . '</span></a></li>'; ?>
                    <li><a href="/manage/guild/<?php echo $id; ?>/overview" ><span class="aside-icon" ><ion-icon name="apps-outline"></ion-icon></span><span class="title" >Overview</span></a></li>
                    ...
                    <li class="selected" ><a href="/manage/guild/<?php echo $id; ?>/text-settings" ><span class="aside-icon" ><ion-icon name="create-outline"></ion-icon></span><span class="title" >Text settings</span></a></li>
