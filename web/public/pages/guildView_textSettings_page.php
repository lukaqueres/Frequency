...
<div class="card-container">
                        ...
                        <div class="card transparent full card-container">
                            ...
                            <div class="card transparent">
                                <ul class="no-points">
                                    <li><label class="chck-label"><input type="checkbox" id="blacklist_domains"/><span class="label">Blacklist domains</span></label><div class="explanation"><span class="explanation-mark"><ion-icon name="information-circle"></ion-icon></span><div class="explanation-content">EXPLANATION CONTENT BITCH</div></div></li>
