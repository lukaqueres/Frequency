...
class TicketCloseConfirmView(discord.ui.View):
	...
	@discord.ui.TextInput(label = "Reason", style=TextStyle.short, custom_id = ticket_reason_of_close_input, placeholder="Input reason for ticket close", default=None, required=False, min_length=0, max_length=100, row=2)
