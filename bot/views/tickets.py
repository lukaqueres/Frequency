...
class TextInput(discord.ui.TextInput):
	def __init__(self):
		...
		super().__init__(label = "Reason", style=discord.TextStyle.long, custom_id = "ticket_reason_of_close_input", placeholder="Input reason for ticket close", min_length=0, max_length=100, required = False, row=1)
